...
testrunner.bugvault:
	$(podman) exec -it testrunner tox -e unit-tests bugvault
testrunner.bzimport:
...
testrunner.all-unit-tests:
	$(podman) exec -it testrunner tox -e unit-tests collectors/bzimport collectors/jiraffe collectors/product_definitions bugvault
...
testrunner.record-new:
	rm -rf *_cache.sqlite
	$(podman) exec -it testrunner tox -e record-new bugvault/ collectors/jiraffe collectors/bzimport collectors/product_definitions
