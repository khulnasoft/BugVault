...
First, let's try to get the API's status by hitting the `bugvault/api/v1/status` endpoint.

With cURL

```bash
$ curl ${SERVICE_URL}/bugvault/api/v1/status
```
...
response = requests.get("${SERVICE_URL}/bugvault/api/v1/status")
```
...
$ curl -H "Authorization: Bearer <access_token>"\
       ${SERVICE_URL}/bugvault/api/v1/status
```
...
response = requests.get("${SERVICE_URL}/bugvault/api/v1/status", headers=headers)
assert response.ok
```
...
```bash
$ curl -H "Authorization: Bearer <access_token>" \
       ${SERVICE_URL}/bugvault/api/v1/flaws
```
...
headers = {"Authorization": "Bearer <access_token>"}
response = requests.get("${SERVICE_URL}/bugvault/api/v1/flaws", headers=headers)
assert response.ok
```
...
```bash
$ curl -H "Authorization: Bearer <access_token>" \
       ${SERVICE_URL}/bugvault/api/v1/flaws/2fe16efb-11cb-4cd2-b31b-d769ba821073
```
...
headers = {"Authorization": "Bearer <access_token>"}
response = requests.get(f"${SERVICE_URL}/bugvault/api/v1/flaws/{flaw_id}", headers=headers)
assert response.ok
```
...
```bash
$ curl -H "Authorization: Bearer <access_token>" \
       ${SERVICE_URL}/bugvault/api/v1/flaws/CVE-2005-0001
```
...
```bash
$ curl -H "Authorization: Bearer <access_token>" \
       ${SERVICE_URL}/bugvault/api/v1/flaws?changed_after=2021-11-18
```
...
response = requests.get("${SERVICE_URL}/bugvault/api/v1/flaws", headers=headers, params=params)
assert response.ok
```
...
```bash
$ curl -H "Authorization: Bearer <access_token>" \
       ${SERVICE_URL}/bugvault/api/v1/flaws?search=openjdk
```
...
```bash
$ curl -H "Authorization: Bearer <access_token>" \
       ${SERVICE_URL}/bugvault/api/v1/flaws?include_fields=cve_id,comments
```

```bash
$ curl -H "Authorization: Bearer <access_token>" \
       ${SERVICE_URL}/bugvault/api/v1/flaws?exclude_fields=comments
```

```bash
$ curl -H "Authorization: Bearer <access_token>" \
       ${SERVICE_URL}/bugvault/api/v1/flaws?include_meta_attr=*
```
...
$ curl -H "Authorization: Token 835b5dd8b69d2a6f79adaf3f29e926e138b6c847" \
       ${SERVICE_URL}/bugvault/api/v1/flaws?include_fields=affects.ps_module
```

```bash
$ curl -H "Authorization: Token 835b5dd8b69d2a6f79adaf3f29e926e138b6c847" \
       ${SERVICE_URL}/bugvault/api/v1/flaws?exclude_fields=affects.trackers.external_system_id
```

```bash
$ curl -H "Authorization: Token 835b5dd8b69d2a6f79adaf3f29e926e138b6c847" \
       ${SERVICE_URL}/bugvault/api/v1/flaws?include_meta_attr=affects.*,affects.trackers.bz_id
```
...
```bash
$ curl -H "Authorization: Token 835b5dd8b69d2a6f79adaf3f29e926e138b6c847" \
       ${SERVICE_URL}/bugvault/api/v1/flaws?tracker_ids=AAH-1284,2038382
```
...
response = requests.post("${SERVICE_URL}/bugvault/api/v1/flaws", headers=headers, json=data)
assert response.ok
```
...
$ curl -H "Authorization: Bearer <access_token>" \
       ...
       ${SERVICE_URL}/bugvault/api/v1/flaws/CVE-2161-0013
```
...
response = requests.put("${SERVICE_URL}/bugvault/api/v1/flaws/CVE-2161-0013", headers=headers, json=data)
assert response.ok
```
...
headers = {"Authorization": "Bearer <access_token>"}
response = requests.delete("${SERVICE_URL}/bugvault/api/v1/flaws/CVE-2161-0013", headers=headers)
assert response.ok
```
...
```bash
$ curl -H "Authorization: Bearer <access_token>" \
       ${SERVICE_URL}/bugvault/api/v1/flaws/2fe16efb-11cb-4cd2-b31b-d769ba821073/comments
```
...
flaw_id = "2fe16efb-11cb-4cd2-b31b-d769ba821073"
headers = {"Authorization": "Bearer <access_token>"}
response = requests.get(f"{SERVICE_URL}/bugvault/api/v1/flaws/{flaw_id}/comments", headers=headers)
assert response.ok
```
...
```bash
$ curl -H "Authorization: Bearer <access_token>" \
       "${SERVICE_URL}/bugvault/api/v1/flaws/2fe16efb-11cb-4cd2-b31b-d769ba821073/comments?order=3"
```
...
order = 3
headers = {"Authorization": "Bearer <access_token>"}
response = requests.get(f"{SERVICE_URL}/bugvault/api/v1/flaws/{flaw_id}/comments?order={order}", headers=headers)
assert response.ok
```
...
```bash
$ curl -H "Authorization: Bearer <access_token>" \
       ${SERVICE_URL}/bugvault/api/v1/flaws/CVE-2005-0001/comments?external_system_id=15567963
```
...
headers = {"Authorization": "Bearer <access_token>"}
response = requests.get(f"{SERVICE_URL}/bugvault/api/v1/flaws/{flaw_id}/comments?external_system_id={external_system_id}", headers=headers)
assert response.ok
```
...
```bash
$ curl -H "Authorization: Bearer <access_token>" \
       ${SERVICE_URL}/bugvault/api/v1/flaws/CVE-2005-0001/comments/acef1a6c-890b-4abb-85c1-d81e76cd7858
```
...
headers = {"Authorization": "Bearer <access_token>"}
response = requests.get(f"{SERVICE_URL}/bugvault/api/v1/flaws/{flaw_id}/comments/{comment_id}", headers=headers)
assert response.ok
```
...
response = requests.post(f"{SERVICE_URL}/bugvault/api/v1/flaws/{flaw_id}/comments", headers=headers, json=data)
assert response.ok
```
