...
from bugvault.helpers import filter_cves
from bugvault.mixins import AlertMixin, TrackingMixin
...
class FlawConvertor(BugzillaGroupsConvertorMixin):
    ...
    def __init__(
        ...
        # set bugvault.acl to be able to CRUD database properly and essentially bypass ACLs as
