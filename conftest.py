...
from bugvault.models import PsModule, PsUpdateStream
from bugvault.tests.factories import PsModuleFactory, PsProductFactory
...
def enable_bz_sync(monkeypatch) -> None:
    ...
    import bugvault.models.flaw.flaw as flaw_module
    import bugvault.models.tracker as tracker
...
def enable_jira_task_sync(monkeypatch) -> None:
    ...
    import bugvault.serializer as serializer
...
def enable_jira_task_async_sync(enable_jira_task_sync, monkeypatch) -> None:
    ...
    enable the sync of tasks to Jira
    """
    from bugvault.models.flaw import flaw
...
def set_recording_environments(
    ...
    from collectors.osv import collectors as osv_collector
    from bugvault.models import snippet
