"""
    bugvault middleware is responsible for injecting ldap user acls into all sql calls.
...
class PgCommon:
    """Set bugvault.acl environment variable on all db calls

    bugvault.acl is used with row-level security to control access to data
