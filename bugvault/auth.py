...
class BugvaultTokenAuthentication(JWTAuthentication):
    """authenticate token"""
...
class BugvaultTokenAuthenticationScheme(SimpleJWTScheme):
    """OpenAPI scheme extension for custom auth class to be properly discovered"""

    target_class = BugvaultTokenAuthentication
    name = "BugvaultTokenAuthentication"
