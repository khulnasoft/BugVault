"""
implement bugvault rest api views
"""
...
def healthy(request: Request) -> Response:
    """unauthenticated view providing healthcheck on bugvault service"""
    return Response()
...
class StatusView(RudimentaryUserPathLoggingMixin, APIView):
    """authenticated view containing status bugvault service"""
    ...
    def get(self, request, *args, **kwargs):
        ...
        return Response(
            {
                "bugvault_service": {},
                "bugvault_data": {"flaw_count": Flaw.objects.all().count()},
            }
        )
    ...
    list=extend_schema(
        ...
        parameters=[
            ...
            OpenApiParameter(
                ...
                type=OpenApiTypes.STR,
                location=OpenApiParameter.QUERY,
                # See bugvault/helpers.py::get_mixin_subclases for getting all models
