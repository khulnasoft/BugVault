...
class JSONSocketHandler(logging.handlers.SocketHandler):
    ...
    def makeSocket(self, *args, **kwargs):
        ...
        context.load_verify_locations(
            cafile="/opt/app-root/etc/logstash/certs/bugvault-logstash-ca.crt"
        )
        context.load_cert_chain(
            certfile="/opt/app-root/etc/logstash/certs/bugvault-logstash.crt",
            keyfile="/opt/app-root/etc/logstash/certs/bugvault-logstash.key",
        )
