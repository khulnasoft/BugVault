...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('bugvault', '0080_alter_flawacknowledgment_affiliation'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flaw', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='cvss_scores', to='bugvault.flaw')),
            ],
        ),
        migrations.CreateModel(
            name='AffectCVSS',
            fields=[
                ...
                ('comment', models.TextField(blank=True)),
                ('score', models.FloatField(default=0)),
                ('affect', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='cvss_scores', to='bugvault.affect')),
            ],
        ),
