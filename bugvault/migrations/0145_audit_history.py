...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('bugvault', '0144_remove_flawcomment_meta_attr'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, serialize=False)),
                ('cve_id', models.CharField(blank=True, max_length=500, null=True, validators=[bugvault.validators.validate_cve_id])),
                ('impact', models.CharField(blank=True, choices=[('', 'Novalue'), ('LOW', 'Low'), ('MODERATE', 'Moderate'), ('IMPORTANT', 'Important'), ('CRITICAL', 'Critical')], max_length=20)),
                ...
                ('cwe_id', models.CharField(blank=True, max_length=255, validators=[bugvault.validators.validate_cwe_id])),
                ...
                ('reported_dt', models.DateTimeField(blank=True, null=True, validators=[bugvault.validators.no_future_date])),
        ...
        migrations.AddField(
            model_name='flawaudit',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='bugvault.flaw'),
        ),
        migrations.AddField(
            model_name='affectaudit',
            name='flaw',
            field=models.ForeignKey(db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='+', to='bugvault.flaw'),
        ),
        migrations.AddField(
            model_name='affectaudit',
            name='pgh_context',
        ...
        migrations.AddField(
            model_name='affectaudit',
            name='pgh_obj',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='bugvault.affect'),
        ),
        pgtrigger.migrations.AddTrigger(
            model_name='flawaudit',
            trigger=pgtrigger.compiler.Trigger(name='append_only', sql=pgtrigger.compiler.UpsertTriggerSql(func="RAISE EXCEPTION 'pgtrigger: Cannot update or delete rows from % table', TG_TABLE_NAME;", hash='195cbee13b88d274b393e907e94b01bdfa87a596', operation='UPDATE OR DELETE', pgid='pgtrigger_append_only_b8a4b', table='bugvault_flawaudit', when='BEFORE')),
        ),
        pgtrigger.migrations.AddTrigger(
            model_name='affectaudit',
            trigger=pgtrigger.compiler.Trigger(name='append_only', sql=pgtrigger.compiler.UpsertTriggerSql(func="RAISE EXCEPTION 'pgtrigger: Cannot update or delete rows from % table', TG_TABLE_NAME;", hash='ca2d9223a1a2e17b9fdc59a87fdcaba3362e963a', operation='UPDATE OR DELETE', pgid='pgtrigger_append_only_fa9ab', table='bugvault_affectaudit', when='BEFORE')),
        ),
