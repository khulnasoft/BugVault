    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flaw', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='labels', to='bugvault.flaw')),
                ('label', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bugvault.flawlabel', to_field='name')),
            ],
        ),
