...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('bugvault', '0078_flaw_major_incident_state'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flaw', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='acknowledgments', to='bugvault.flaw')),
            ],
            options={
