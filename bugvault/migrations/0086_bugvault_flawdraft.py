...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('bugvault', '0085_flaw_nist_cvss_validation'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flaw', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='bugvault.flaw')),
            ],
            options={
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['-created_dt'], name='bugvault_flawd_created_e389e0_idx'),
        ),
    ]
