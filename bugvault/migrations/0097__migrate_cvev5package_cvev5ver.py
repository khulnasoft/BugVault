...
def generate_vers(apps):
    ...
    """
    CVEv5Version = apps.get_model("bugvault", "CVEv5Version")
    CVEv5PackageVersions = apps.get_model("bugvault", "CVEv5PackageVersions")
    PackageVer = apps.get_model("bugvault", "PackageVer")
    Package = apps.get_model("bugvault", "Package")
    for old_ver in (
...
class Migration(migrations.Migration):
    dependencies = [
        ("bugvault", "0096_cvev5package__alerts"),
    ]
