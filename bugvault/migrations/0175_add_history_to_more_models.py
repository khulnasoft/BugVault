...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ("bugvault", "0174_remove_affect_insert_insert_and_more"),
    ]
    ...
    operations = [
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    func='INSERT INTO "bugvault_affectcvssaudit" ("acl_read", "acl_write", "affect_id", "comment", "created_dt", "issuer", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "score", "updated_dt", "uuid", "vector", "version") VALUES (NEW."acl_read", NEW."acl_write", NEW."affect_id", NEW."comment", NEW."created_dt", NEW."issuer", _pgh_attach_context(), NOW(), \'insert\', NEW."uuid", NEW."score", NEW."updated_dt", NEW."uuid", NEW."vector", NEW."version"); RETURN NULL;',
                    hash="745425a72800252cbb9dc4680abab6388b85416f", # pragma: allowlist secret
                    operation="INSERT",
                    pgid="pgtrigger_insert_insert_b9f93",
                    table="bugvault_affectcvss",
                    when="AFTER",
                ),
            ),
        ),
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                name="delete_delete",
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    func='INSERT INTO "bugvault_affectcvssaudit" ("acl_read", "acl_write", "affect_id", "comment", "created_dt", "issuer", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "score", "updated_dt", "uuid", "vector", "version") VALUES (OLD."acl_read", OLD."acl_write", OLD."affect_id", OLD."comment", OLD."created_dt", OLD."issuer", _pgh_attach_context(), NOW(), \'delete\', OLD."uuid", OLD."score", OLD."updated_dt", OLD."uuid", OLD."vector", OLD."version"); RETURN NULL;',
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                name="insert_insert",
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    func='INSERT INTO "bugvault_flawacknowledgmentaudit" ("acl_read", "acl_write", "affiliation", "created_dt", "flaw_id", "from_upstream", "name", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "updated_dt", "uuid") VALUES (NEW."acl_read", NEW."acl_write", NEW."affiliation", NEW."created_dt", NEW."flaw_id", NEW."from_upstream", NEW."name", _pgh_attach_context(), NOW(), \'insert\', NEW."uuid", NEW."updated_dt", NEW."uuid"); RETURN NULL;',
                    hash="71eb9f0cd83f892cf1cc4a974e2ae6af5c78664a", # pragma: allowlist secret
                    operation="INSERT",
                    pgid="pgtrigger_insert_insert_8d8ea",
                    table="bugvault_flawacknowledgment",
                    when="AFTER",
                ),
            ),
        ),
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                name="delete_delete",
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    func='INSERT INTO "bugvault_flawacknowledgmentaudit" ("acl_read", "acl_write", "affiliation", "created_dt", "flaw_id", "from_upstream", "name", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "updated_dt", "uuid") VALUES (OLD."acl_read", OLD."acl_write", OLD."affiliation", OLD."created_dt", OLD."flaw_id", OLD."from_upstream", OLD."name", _pgh_attach_context(), NOW(), \'delete\', OLD."uuid", OLD."updated_dt", OLD."uuid"); RETURN NULL;',
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                name="insert_insert",
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    func='INSERT INTO "bugvault_flawcommentaudit" ("acl_read", "acl_write", "created_dt", "creator", "external_system_id", "flaw_id", "is_private", "order", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "synced_to_bz", "text", "updated_dt", "uuid") VALUES (NEW."acl_read", NEW."acl_write", NEW."created_dt", NEW."creator", NEW."external_system_id", NEW."flaw_id", NEW."is_private", NEW."order", _pgh_attach_context(), NOW(), \'insert\', NEW."uuid", NEW."synced_to_bz", NEW."text", NEW."updated_dt", NEW."uuid"); RETURN NULL;',
                    hash="0152daee73627bc5b8064196397a9996343732fd", # pragma: allowlist secret
                    operation="INSERT",
                    pgid="pgtrigger_insert_insert_5fac1",
                    table="bugvault_flawcomment",
                    when="AFTER",
                ),
            ),
        ),
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                name="delete_delete",
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    func='INSERT INTO "bugvault_flawcommentaudit" ("acl_read", "acl_write", "created_dt", "creator", "external_system_id", "flaw_id", "is_private", "order", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "synced_to_bz", "text", "updated_dt", "uuid") VALUES (OLD."acl_read", OLD."acl_write", OLD."created_dt", OLD."creator", OLD."external_system_id", OLD."flaw_id", OLD."is_private", OLD."order", _pgh_attach_context(), NOW(), \'delete\', OLD."uuid", OLD."synced_to_bz", OLD."text", OLD."updated_dt", OLD."uuid"); RETURN NULL;',
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                name="insert_insert",
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    func='INSERT INTO "bugvault_flawcvssaudit" ("acl_read", "acl_write", "comment", "created_dt", "flaw_id", "issuer", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "score", "updated_dt", "uuid", "vector", "version") VALUES (NEW."acl_read", NEW."acl_write", NEW."comment", NEW."created_dt", NEW."flaw_id", NEW."issuer", _pgh_attach_context(), NOW(), \'insert\', NEW."uuid", NEW."score", NEW."updated_dt", NEW."uuid", NEW."vector", NEW."version"); RETURN NULL;',
                    hash="e36295da9a14912632b72a85926a6fc536718feb", # pragma: allowlist secret
                    operation="INSERT",
                    pgid="pgtrigger_insert_insert_c1c4a",
                    table="bugvault_flawcvss",
                    when="AFTER",
                ),
            ),
        ),
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                name="delete_delete",
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    func='INSERT INTO "bugvault_flawcvssaudit" ("acl_read", "acl_write", "comment", "created_dt", "flaw_id", "issuer", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "score", "updated_dt", "uuid", "vector", "version") VALUES (OLD."acl_read", OLD."acl_write", OLD."comment", OLD."created_dt", OLD."flaw_id", OLD."issuer", _pgh_attach_context(), NOW(), \'delete\', OLD."uuid", OLD."score", OLD."updated_dt", OLD."uuid", OLD."vector", OLD."version"); RETURN NULL;',
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                name="insert_insert",
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    func='INSERT INTO "bugvault_flawreferenceaudit" ("acl_read", "acl_write", "created_dt", "description", "flaw_id", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "type", "updated_dt", "url", "uuid") VALUES (NEW."acl_read", NEW."acl_write", NEW."created_dt", NEW."description", NEW."flaw_id", _pgh_attach_context(), NOW(), \'insert\', NEW."uuid", NEW."type", NEW."updated_dt", NEW."url", NEW."uuid"); RETURN NULL;',
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                name="delete_delete",
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    func='INSERT INTO "bugvault_flawreferenceaudit" ("acl_read", "acl_write", "created_dt", "description", "flaw_id", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "type", "updated_dt", "url", "uuid") VALUES (OLD."acl_read", OLD."acl_write", OLD."created_dt", OLD."description", OLD."flaw_id", _pgh_attach_context(), NOW(), \'delete\', OLD."uuid", OLD."type", OLD."updated_dt", OLD."url", OLD."uuid"); RETURN NULL;',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                related_name="+",
                related_query_name="+",
                to="bugvault.bztrackerdownloadmanager",
            ),
        ),
        migrations.AddField(
            model_name="trackeraudit",
            ...
            field=models.ForeignKey(
                ...
                related_name="+",
                related_query_name="+",
                to="bugvault.bztrackerlinkmanager",
            ),
        ),
        migrations.AddField(
            model_name="trackeraudit",
            ...
            field=models.ForeignKey(
                ...
                related_name="+",
                related_query_name="+",
                to="bugvault.jiratrackerdownloadmanager",
            ),
        ),
        migrations.AddField(
            model_name="trackeraudit",
            ...
            field=models.ForeignKey(
                ...
                related_name="+",
                related_query_name="+",
                to="bugvault.jiratrackerlinkmanager",
            ),
        ),
        migrations.AddField(
            model_name="trackeraudit",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                on_delete=django.db.models.deletion.DO_NOTHING,
                related_name="events",
                to="bugvault.flawacknowledgment",
            ),
        ),
        migrations.AddField(
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    ...
                    table="bugvault_flawreferenceaudit",
                    when="BEFORE",
                ),
            ),
        ),
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    ...
                    table="bugvault_flawcommentaudit",
                    when="BEFORE",
                ),
            ),
        ),
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    ...
                    table="bugvault_flawacknowledgmentaudit",
                    when="BEFORE",
                ),
            ),
        ),
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    ...
                    table="bugvault_affectcvssaudit",
                    when="BEFORE",
                ),
            ),
        ),
