...
class Affect(
    ...
    # to fix https://issues.redhat.com/browse/BUGVAULT-635
    ...
    def _validate_ps_module_old_flaw(self, **kwargs):
        ...
        flaws unupdatable.
        """
        from bugvault.constants import BZ_ID_SENTINEL
    ...
    def _validate_sofware_collection(self, **kwargs):
        ...
        """
        from bugvault.constants import COMPONENTS_WITHOUT_COLLECTION
    ...
    def _validate_wontreport_products(self, **kwargs):
        ...
        """
        from bugvault.constants import SERVICES_PRODUCTS
