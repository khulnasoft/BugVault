...
from bugvault.models import FlawSource, Impact, PsModule, SpecialConsiderationPackage
from bugvault.query_sets import CustomQuerySetUpdatedDt
from bugvault.sync_manager import (
    BZSyncManager,
    FlawDownloadManager,
...
from bugvault.validators import no_future_date, validate_cve_id, validate_cwe_id
...
class FlawManager(ACLMixinManager, TrackingMixinManager):
    ...
    def fts_search(q):
        ...
        from bugvault.filters import search_helper
...
class Flaw(
    ...
    def _validate_flaw_without_affect(self, **kwargs):
        ...
        """
        from bugvault.models import Affect
    ...
    def _validate_unsupported_impact_change(self, **kwargs):
        ...
        """
        from bugvault.models import Tracker
