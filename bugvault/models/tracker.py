...
from bugvault.models.affect import Affect
...
class Tracker(AlertMixin, TrackingMixin, NullStrFieldsMixin, ACLMixin):
            ...
            try:
                ...
                if (
                    (
                        ...
                        and "bugvault_tracker_type_external_system_id" in exc_msg
                    )
    ...
    def _validate_tracker_flaw_accesses(self, **kwargs):
        ...
        """
        from bugvault.models.flaw.flaw import Flaw
    ...
    def references(self):
        ...
        from bugvault.models.flaw.flaw import Flaw
        from bugvault.models.flaw.reference import FlawReference
