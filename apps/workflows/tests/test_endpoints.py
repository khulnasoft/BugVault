...
from bugvault.models import Affect, Flaw, Tracker
...
class TestEndpoints(object):
    ...
    def test_promote_endpoint(
        ...
        response = auth_client().post(
            f"{test_api_uri_bugvault}/flaws/{flaw.uuid}/promote",
            data={},
            format="json",
            **headers,
        )
    ...
    def test_reject_endpoint(
        ...
        response = auth_client().post(
            f"{test_api_uri_bugvault}/flaws/{flaw.uuid}/reject",
            data={},
            format="json",
            **headers,
        )
