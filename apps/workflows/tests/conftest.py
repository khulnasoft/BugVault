...
def test_scheme_host():
    return "http://bugvault-service:8000/workflows"


@pytest.fixture
def test_scheme_host_bugvault():
...
@pytest.fixture
def test_api_uri_bugvault(test_scheme_host_bugvault, api_version):
    return f"{test_scheme_host_bugvault}/api/{api_version}"
